...
<div id="addUser" style="display: none">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-mid layui-word-aux">开:启用,关:禁用</div>
        </div>
        <div class="layui-form-item">
...
<!--        <button class="layui-btn layui-btn-sm" lay-event="getCheckLength">获取选中数目</button>-->
<!--        <button class="layui-btn layui-btn-sm" lay-event="isAll">验证是否全选</button>-->
        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" lay-event="addUser"><i class="layui-icon"></i></button>
<!--        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" lay-event="getCheckData"><i class="layui-icon"></i></button>-->
        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" lay-event="delUsers"><i class="layui-icon"></i></button>
    </div>
</script>
...
//        });
    ...
    layui.use('form', function(){
        ...
        form.on('submit(addUser)', function(data){
            ...
            ajax('{url("auth/addUser")}',JSON.stringify(data.field),'POST');
            return false;
        });
    });
</script>
